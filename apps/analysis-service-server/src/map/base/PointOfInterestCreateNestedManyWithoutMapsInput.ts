...
@InputType()
class PointOfInterestCreateNestedManyWithoutMapsInput {
...
export { PointOfInterestCreateNestedManyWithoutMapsInput as PointOfInterestCreateNestedManyWithoutMapsInput };

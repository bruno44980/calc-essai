...
@InputType()
class AnalysisCreateNestedManyWithoutDocumentsInput {
...
export { AnalysisCreateNestedManyWithoutDocumentsInput as AnalysisCreateNestedManyWithoutDocumentsInput };
